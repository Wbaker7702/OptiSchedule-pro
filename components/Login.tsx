...
import { CalendarDays, Lock, Mail, ArrowRight, Store } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-slate-900 p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">OptiSchedule Pro</h1>
          <p className="text-blue-200 text-sm">Walmart Store Management Portal</p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
              ...
              <span>Enterprise Edition • Version 2.4.0</span>
            </div>
          </div>
        </div>
      </div>
