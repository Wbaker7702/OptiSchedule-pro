...
import { LayoutDashboard, CalendarDays, Activity, Package, BarChart3, Users, Settings, Search, LogOut } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, onLogout }) => {
  const menuItems = [
    ...
    { id: View.EXPLORER, label: 'Explorer', icon: Search },
  ];
